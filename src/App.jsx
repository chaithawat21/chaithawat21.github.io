        ...
        <div className='content'>
          <div className='top'>
            ...
            <div className="icon-link">
              <a href="https://www.linkedin.com/in/chaithawat/" target="_blank" rel="noopener noreferrer">
                <img className="icon" src={Linkedin} alt="Linkedin" />
              </a>
              <a href="https://github.com/chaithawat21" target="_blank" rel="noopener noreferrer">
          ...
          <div className="middle">
            ...
            <a href="https://drive.google.com/file/d/1C7swNxf8N-4HyrCv2a0F_6uMcsaN_wze/view?usp=drive_link" target="_blank"><img className="o2o-img" src={screenshot} alt="screenshot" /></a>
